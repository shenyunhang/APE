...
# REC R50
config_files=(
	#"configs/REFCOCO_VisualGrounding/something/something_r50_12ep.py" # bs=16 for training
	#"configs/REFCOCO_VisualGrounding/something/something_r50_vlf_12ep.py" # bs=16 for training
)
...
# REC ViT-L
config_files=(
	#"configs/REFCOCO_VisualGrounding/something/something_vitl_eva02_clip_lsj1024_12ep.py" # bs=8 for training
	#"configs/REFCOCO_VisualGrounding/something/something_vitl_eva02_clip_vlf_lsj1024_12ep.py"  # bs=8 for training
)
...
# OVD R50
config_files=(
	#"configs/COCO_InstanceSegmentation/something/something_r50_12ep.py" # bs=16 for training
	#"configs/LVIS_InstanceSegmentation/something/something_r50_24ep.py" # bs=16 for training
	#"configs/COCO_InstanceSegmentation/something/something_r50_vlf_12ep.py" # bs=16 for training
	#"configs/LVIS_InstanceSegmentation/something/something_r50_vlf_24ep.py" # bs=16 for training
)
...
# OVD ViT-L
config_files=(
	#"configs/COCO_InstanceSegmentation/something/something_vitl_eva02_clip_lsj1024_cp_12ep.py" # bs=8 for training
	#"configs/LVIS_InstanceSegmentation/something/something_vitl_eva02_clip_lsj1024_cp_24ep.py" # bs=8 for training
	#"configs/COCO_InstanceSegmentation/something/something_vitl_eva02_clip_vlf_lsj1024_cp_12ep.py" # bs=8 for training
	"configs/LVIS_InstanceSegmentation/something/something_vitl_eva02_clip_vlf_lsj1024_cp_24ep.py" # bs=8 for training
)
